...
export default function Home() {
  ...
  <a href="/library-tracker" className="block rounded-xl p-4 cursor-pointer transform transition-transform duration-300 hover:scale-105">
    <div className="flex flex-col items-start">
      <img className="w-full h-auto rounded-xl" src="/content/books.png" alt="Card Image" />
      <div className="mt-4">
        <h3 className="text-lg font-bold text-additional">Library-tracker</h3>
        <p className="mt-1 text-additional">Python, ML, and OCR</p>
      </div>
    </div>
  </a>
  ...
  <a href="/holography" className="block rounded-xl p-4 cursor-pointer transform transition-transform duration-300 hover:scale-105">
    <div className="flex flex-col items-start">
      ...
      <div className="mt-4">
        ...
        <p className="mt-1 text-additional">Maths, Maths and more Maths.</p>
      </div>
    </div>
  </a>
