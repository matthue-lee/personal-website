      ...
      <div className="flex-grow flex flex-col items-center">
       ...
       {/* Small Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-20 mt-40 mb-8 w-[80%]">
          <a href="/spectral-analysis" className="relative block bg-stone-200 border shadow-sm rounded-xl p-4 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70 cursor-pointer transform transition-transform duration-300 hover:scale-105">
            <div className="p-16 border-4 border-stone-200 rounded-lg overflow-hidden">
            <img className="w-full h-auto rounded-xl" src="/content/sbm.jpg" alt="Card Image"/>
            </div>
            <div className="absolute top-0 left-0 right-0">
              <div className="p-3 md:p-5">
                <h3 className="text-lg font-bold text-additional">
                  Spectral Analysis
                </h3>
                <p className="mt-1 text-additional">
                  A foray into machine learning and SVM&#39;s
                </p>
              </div>
            </div>
          </a>
          <a href="/underactuated-gripper" className="relative block bg-stone-200 border shadow-sm rounded-xl p-4 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70 cursor-pointer transform transition-transform duration-300 hover:scale-105">
          <div className="p-20 border-4 border-stone-200 rounded-lg overflow-hidden">
          ...
          <a href="/holography" className="relative block bg-stone-200 border shadow-sm rounded-xl p-4 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70 cursor-pointer transform transition-transform duration-300 hover:scale-105">
          <div className="p-20 border-4 border-stone-200 rounded-lg overflow-hidden">
          ...
          <a href="/surfboard-rack" className="relative block bg-stone-200 border shadow-sm rounded-xl p-4 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70 cursor-pointer transform transition-transform duration-300 hover:scale-105">
          <div className="p-16 border-4 border-stone-200 rounded-lg overflow-hidden">
