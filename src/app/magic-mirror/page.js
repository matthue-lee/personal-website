...
export default function Page() {
  ...
  return (
    <div className="md:p-10 bg-white px-2 arial-font">
      ...
      <p className="mt-1 text-gray-800 text-lg md:text-2xl">
      ...
      <div className="mt-20 text-center mx-auto max-w-4xl">
        <p className="mb-20 text-gray-700 text-lg md:text-2xl">
      ...
      {/* Text Paragraph */}
      <p className="mb-10 mt-15 text-gray-700 md:w-2/3 text-lg md:text-2xl md:mr-8">
    ...
    const handleOutlookEmail = async (e) => {
      ...
      .catch((error) => {
        ...
        <p className="mt-36 text-gray-700 text-lg md:text-2xl">
